        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    MenuCategoriesId = table.Column<Guid>(type: "uuid", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_MenuCategories_MenuCategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.MenuItemsId });
                    table.ForeignKey(
                        name: "FK_OrderItems_Menus_MenuItemsId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "39de72c3-a4b3-46b2-96ac-035c782ea250", null, "Customer", "CUSTOMER" },
                    { "bc170fd1-2d32-49cc-a09b-692989540f7b", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menus_MenuCategoriesId",
                table: "Menus",
